...
class AdminController extends Controller
{
    ...
    {
        return response()->json(
            User::latest()->get(['id', 'name', 'email', 'role', 'created_at'])
        );
    }
    ...
    public function makeAdmin($id)
    {
        ...
        $user->role = 'admin';
        $user->save();
        return response()->json(['message' => 'User dijadikan admin', 'user' => $user]);
    }
    ...
    public function makePremium($id)
    {
        ...
        $user->role = 'premium';
        $user->save();
        return response()->json(['message' => 'User dijadikan premium', 'user' => $user]);
    }
    ...
    public function makeFree($id)
    {
        ...
        $user->role = 'free';
        $user->save();
        return response()->json(['message' => 'User dijadikan free', 'user' => $user]);
    }
}